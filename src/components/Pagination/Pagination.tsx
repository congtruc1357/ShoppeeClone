...
export default function Pagination({ queryConfig, pageSize }: Props) {
  ...
  return (
    <div className='mt-6 flex flex-wrap mt-6 justify-center'>
      {page === 1 ? (
        <span className='bg-white cursor-not-allowed rounded px-3 py-2 shadow-sm mx-2 border'>Prev</span>
      ) : (
        <Link
          to={{
            pathname: path.home,
          ...
          className='bg-white/60 rounded px-3 py-2 shadow-sm mx-2 cursor-pointer border'
        >
          Prev
        </Link>
      )}
