          ...
          {isAuthenticated && (
            ...
            >
              <div className='w-6 mr-2 flex-shrink-0'>
                <img
                  src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSGSW78J4lIkkYlaVemzSoA4jkRI9dZwZ8G2A&s'
                ...
                <div className='bg-white relative shadow-md rounded-sm border border-gray-200 max-w-[400px] text-sm'>
                  <div className='p-2'>
                    ...
                    <div className='mt-5'>
                      <div className='mt-4 flex'>
                        <div className='flex-shrink-0'>
                          <img
                            src='https://toysonejapan.com/cdn/shop/files/s-l1600_11_973f322e-3fc2-4253-ad49-4f6f94d63eaa.webp?v=1746668974&width=800'
                            alt='img'
                        ...
                        <div className='flex-grow ml-2 overflow-hidden'>
                          <div className='truncate'>
                            Sentai Ring - Number One Sentai Gozyuger nhẫn siêu nhân Tegasword đeo tay Universe Senshi
                          </div>
                        </div>
                        <div className='ml-2 flex-shrink-0'>
                          <div className='text-orange'>260.000₫ - 440.000₫</div>
                        </div>
                      </div>
                      <div className='mt-4 flex'>
                        <div className='flex-shrink-0'>
                    ...
                    <div className='flex mt-6 item-center justify-between'>
                      <div className='capitalize test-xs test-gray-500'>Thêm vào giỏ hàng</div>
                      <button className='capitalize bg-orange hover:bg-opacity-90 px-4 py-2 rounded-sm test-white'>
                        Xem giỏ hàng
                      </button>
                    </div>
                  </div>
